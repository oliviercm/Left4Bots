...
::Left4Bots.AllowTakeDamage <- function (damageTable)
{
	...
	if (attackerTeam == TEAM_SURVIVORS || attackerTeam == TEAM_L4D1_SURVIVORS)
	{
		if (victim.IsPlayer() && NetProps.GetPropInt(victim, "m_iTeamNum") == TEAM_SURVIVORS && IsPlayerABot(victim) && IsPlayerABot(attacker) && "Inflictor" in damageTable && damageTable.Inflictor && damageTable.Inflictor.GetClassname() == "inferno")
		{
