::Left4Bots.Settings <-
{
	...
	close_saferoom_door_all_chance = 100
	...
	// 0 = always shoot body
	manual_attack_common_head_radius = 600
	...
	// set 0 to disable.
	manual_attack_saccade_speed = 0

	// max distance of the bot will shoot enemies head, recommended short than "manual_attack_radius", so bots won't waste much ammo when shooting at far target.
	// 0 = always shoot body
	manual_attack_special_head_radius = 900
	...
	vocalize_botselect_timeout = 6.0
