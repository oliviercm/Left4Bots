...
::Left4Bots.Initialize <- function ()
{
	...
	Left4Utils.LoadSettingsFromFileNew("left4bots2/cfg/settings_xyzzy.txt", "Left4Bots.Settings.", Logger);

	Logger.LogLevel(Settings.loglevel);

	Left4Utils.SaveSettingsToFileNew("left4bots2/cfg/settings_xyzzy.txt", Settings, Logger);
